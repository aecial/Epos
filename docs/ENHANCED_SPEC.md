...
4. **React Native POS** — Tablet-based point-of-sale for taking orders (multiple terminals)
5. **KDS Screen** — Kitchen Display System showing live orders with timers
6. **Receipt Printer** — Thermal printer (Goojrpt PT-210) + digital receipt history
